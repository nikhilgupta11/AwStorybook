...
// import AwProductCardQuantitySelector from "./AwProductCardQuantitySelector.vue";
import AwProductCardQuantitySelector from './AwProductCardQuantitySelector.vue';
...
describe("AwProductCardQuantitySelector.vue", () => {
  it("renders Product Card", () => {
    const component = shallowMount(AwProductCard, {
      propsData: {
        title,
      },
    });
...
describe("AwProductCardQuantitySelector.vue: Wish list icon button", () => {
  it("renders Product Card", () => {
    const component = shallowMount(AwProductCard, {
      propsData: {
        title,
  ...
  it("emits click:wishlist event on button click", () => {
    const component = shallowMount(SfProductCard, {
      stubs: {
        wishlistIconButtonClass: AwButton,
      },
      propsData: {
        title,
      },
